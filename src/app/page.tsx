...
export default function Home() {
  return (
    <main className="flex justify-center items-center bg-black min-h-screen py-8 px-4">
      <div className="flex flex-col items-center justify-center max-w-112 text-white text-center">
